							...
							y.ui.mouse,
							{
								...
								_createHandles : function() {
									var P, M, N = this.options, R = this.element
											...
											.addClass(
													"ui-state-default ui-corner-all"), Q = "<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>", O = [];
									...
									this.handles.each(function(S) {
										y(this).data("ui-slider-handle-index",
												S)
									})
								},
								_createRange : function() {
									...
									if (M.range) {
										...
										this.range
												.addClass(N
														+ ((M.range === "min" || M.range === "max") ? " ui-slider-range-"
																+ M.range
																: ""))
									} else {
										if (this.range) {
